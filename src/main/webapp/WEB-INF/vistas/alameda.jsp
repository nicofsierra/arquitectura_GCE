	...
	<div class="container">
		...
		<section>
			<div class="center-block" style="margin-top:5%;">
				...
				<h3 class="text-center">La Alameda Barrio Privado & Spa - Sup.
					cubierta 260 m2</h3>
			</div>
				...
				<div class="col-md-2">
					<div class="thumbnail">
						<a href="img/fotos2/derecha.jpg"> <img
							src="img/fotos2/derecha.jpg" alt="Imagen1" style="width: 100%">
						</a>
					</div>
				</div>
				<div class="col-md-2">
					<div class="thumbnail">
						<a href="img/fotos2/izquierda.jpg"> <img
							src="img/fotos2/izquierda.jpg" alt="Imagen2" style="width: 100%">
						</a>
					</div>
				</div>
				<div class="col-md-2">
				...
				<div class="col-md-2">
					<div class="thumbnail">
						<a href="img/fotos2/pers3.jpg"> <img
							src="img/fotos2/pers3.jpg" alt="Imagen4" style="width: 100%">
						</a>
					</div>
				</div>
				<div class="col-md-2">
					<div class="thumbnail">
						<a href="img/fotos2/pers4.jpg"> <img
							src="img/fotos2/pers4.jpg" alt="Imagen5" style="width: 100%">
						</a>
					</div>
				</div>
			</div>
